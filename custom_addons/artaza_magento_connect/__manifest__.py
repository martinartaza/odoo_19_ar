...
endpoints y autenticación.
    ...
    'data': [
        ...
        'data/ir_cron.xml',
        'wizard/magento_order_import_wizard_views.xml',
        'views/cms_page_views.xml',
        'views/cms_block_views.xml',
        'views/res_config_settings_views.xml',
        'views/magento_rma_views.xml',
        'views/menus.xml',
        'views/product_stock_views.xml',
        'views/sale_order_views.xml',
        'wizard/set_order_total_wizard_views.xml',
        'wizard/magento_rma_approve_wizard_views.xml',
    ],
    'assets': {
        'web.assets_backend': [
